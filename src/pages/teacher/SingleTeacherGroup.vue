...
import AddStudent from "./modals/AttendanceModal.vue";
...
const attendees_student = ref();

date.value = new Date("2023-10-31");
const openModal = async () => {
  group_modal.value.openModal();
  attendees_student.value = await attendees.getAttendees(ID, date.value);
};
