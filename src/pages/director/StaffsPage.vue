<template>
  <div class="w-full pt-5">
    <div class="w-full">
      <staff-modal ref="staff_modal" :roles="roles.roles"></staff-modal>
    </div>
...
<script setup>
import StaffModal from "../director/Modals/StaffModal.vue";
import Loader from "@/components/loader/Loader.vue";
import { onMounted, ref } from "vue";
import { useDirectorStaffsStore } from "../../stores/director/staff";
